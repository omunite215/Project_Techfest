        ...
        <Fade direction="down">
          ...
          <div className="ss:hidden flex flex-1 justify-end items-center">
            ...
            <div
              className={`${
                toggle ? "flex" : "hidden"
              } p-6 bg-gradient-to-b from-violet-500 to-indigo-500 absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar z-20`}
            >
              <ul className="list-none flex flex-col justify-end items-center flex-1">
                {navLinks.map((nav, index) => (
                  ...
                  >
                    <Link href={`${nav.id}`} className={`font-poppins z-50`}>
                      {nav.title}
                    </Link>
                  </li>
                ))}
